...
class Search extends Component {
  ...
  renderDancer = (dancer, props) => {
    return (
      <div style={styles.dancer} key={dancer.id}>
        ...
        <div style={styles.button}><button onClick={() => this.onOpenWaiver(dancer)}>CHECK IN</button></div>
      </div>
    );
  }
  ...
  render() {
    ...
    return (
      <div>
        ...
        <div>
          <Modal open={this.state.waiverOpen} onClose={this.onCloseWaiver} center>
            <div style={styles.modalContent}>
              <form onSubmit={this.checkForm}>
                ...
                <label>Agree</label>
                <br></br>
                <h2><strong>Have you ever been convicted of any of the following crimes</strong></h2>
                <ul>
                ...
                <label><strong>YES</strong>, I <strong>have</strong> committed one of the above crimes</label>
                <br></br>
                <input type="radio" name="crime" value="0" required></input>
                <label><strong>NO</strong>, I <strong>have not</strong> committed one of the above crimes</label>
                <br></br><br></br>
  ...
  checkForm = (form) => {
    ...
    if(noCrime) {
      ...
      alert("Please talk to a staff member... You have asserted that you have committed a crime.");
    }
  }
